...
From the platform plan and backlog, the next missing commerce capability implemented now is:
- Payments + refunds workflow (capture payment for order, partial refunds)
