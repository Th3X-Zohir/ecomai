...
app.use('/v1/delivery', deliveryZonesRoutes);
...
app.use('/v1/settlements', settlementsRoutes);
app.use('/v1/platform/settlements', platformSettlementsRoutes);
app.use('/v1/subscriptions', subscriptionRoutes);
app.use('/v1/reviews', reviewRoutes);
app.use('/v1/newsletter', newsletterRoutes);
app.use('/v1/dashboard', dashboardRoutes);
app.use('/v1/operations', operationsRoutes);
app.use('/v1/cod', codReconciliationRoutes);
